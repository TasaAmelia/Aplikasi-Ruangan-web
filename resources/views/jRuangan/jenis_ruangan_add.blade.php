                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('roomtypename') is-invalid @enderror"
                                name="roomtypename" id="roomtypename" placeholder="Nama Jenis Ruangan" value="{{ old('roomtypename') }}"
                                required autofocus>
                            @error('roomtypename')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('roomtypedescription') is-invalid @enderror"
                                name="roomtypedescription" id="roomtypedescription" placeholder="Keterangan" value="{{ old('roomtypedescription') }}"
                                required>
